...
```{r, echo=FALSE,out.width="49%", out.height="20%",fig.cap="File-Editor und Environment-Oberfläche",fig.show='hold',fig.align='center'}
...
Das Fenster unten rechts (Standardeinstellung, Abb. 2.4a) beinhaltet einen **File-Editor** 
...
Oben rechts (Standardeinstellung, Abb. 2.4b) existiert die **Global Environment**, in dem 
